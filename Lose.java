...
public class Lose extends JPanel implements ActionListener{
  ...
  public Lose(JFrame parent){ //what you want JFrame to look like should be in constructor
        ...
        background.setIcon(new ImageIcon("/Users/kalie_chang/Documents/Ending/youLose.jpeg"));
